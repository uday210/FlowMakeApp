...
// Route prefixes that are always public (webhooks, public forms, embed, auth callbacks)
...
export async function proxy(request: NextRequest) {
  ...
  try {
    ...
    // On unexpected errors, allow the request through rather than blocking with a 500
    return NextResponse.next();
  }
